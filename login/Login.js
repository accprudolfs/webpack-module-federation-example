    ...
    <div className="max-w-md px-12 py-8 bg-white shadow-lg rounded-lg">
      <form>
        ...
        <div className="relative w-full mb-3">
          <input type="email" name="email" className="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="Email" style={{ transition: 'transition: all 0.15s ease 0s' }} />
          <small className="p-2 text-red-500">* Email</small>
        </div>
        <div className="relative w-full mb-3">
          <input type="password" name="password" className="border-0 p-4 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full" placeholder="Password" style={{ transition: 'transition: all 0.15s ease 0s' }} />
